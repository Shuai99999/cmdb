...
def re_chdata(request):
    ...
    cmd = 'nohup su - ' + db_type + ' /home/' + db_type + '/dba/prod/chdata.sh ' + db + ' > /home/' + db_type + '/dba/prod/re_chdata.log'
    ...
    return render(request, 're_chdata.html', {"chdata_result": res.decode()})