...
def re_chdata(request):
    ...
    chdata_result = subprocess.check_output(['su', '-', db_type, '/home/' + db_type + '/dba/prod/chdata.sh', db, '>', '/home/' + db_type + '/dba/prod/re_chdata.log']).decode('utf-8')
    print('gs' + chdata_result)
